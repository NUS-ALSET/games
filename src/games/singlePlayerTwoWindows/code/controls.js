  ...
  render() {
    return (
      <div>
        ...
        <h3 style={{ position: 'fixed', left: 0, top: '12px', zIndex: 1 }}>
          Player 1 score: {Store.score[0]}
        </h3>
        <h3 style={{ position: 'fixed', right: 0, top: '12px', zIndex: 1 }}>
          Player 2 score: {Store.score[1]}
        </h3>
        <h3 style={{ position: 'fixed', left: '45%', top: 0 }}>
        ...
        <button
          style={{ position: 'fixed', left: '70px', top: 0, zIndex: 1 }}
