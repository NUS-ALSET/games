...
import { defaultJavascriptFunctionCode, defaultPythonCodeFunction } from '../commonGameAssets/defaultCode';
    ...
    if (this.state.mode === 'python') {
      ...
      Store.func = `(function() {
        ...
        if(typeof getPlayersCommands==='function'){
          window.result=getPlayersCommands(world,calculateShortestPath);
        }
      }())`;
    }
  };
